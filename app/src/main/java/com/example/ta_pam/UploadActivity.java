...
//        uploadLang = findViewById(R.id.uploadLang);
    ...
    public void saveData(){
        ...
        StorageReference storageReference = FirebaseStorage.getInstance().getReference().child("Antara Images")
...
//        String lang = uploadLang.getText().toString();
        ...
        FirebaseDatabase.getInstance().getReference("Antara Application").child(currentDate)
